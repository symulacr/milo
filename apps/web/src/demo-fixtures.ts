  ...
  images: [
    {
      ...
      alt: "Synthetic Still Studio illustration: sculptural vessel on a warm studio plinth",
    },
    {
      src: "/images/detail.png",
      title: "The details",
      note: "Material study · close composition",
      alt: "Synthetic Still Studio illustration: detail of an olive ceramic vessel",
    },
    {
      src: "/images/collection.png",
      title: "The collection",
      note: "Campaign composition · family portrait",
      alt: "Synthetic Still Studio illustration: the three-piece collection arrangement",
    },
  ],
};
    ...
    images: [
      {
        ...
        alt: "Synthetic Unison illustration: stacked container forms on a plinth",
      },
      {
        src: "/images/sc-02-02.png",
        title: "The join",
        note: "Close detail · render",
        alt: "Synthetic Unison illustration: close study of the container join",
      },
      {
        src: "/images/sc-02-03.png",
        title: "The colorways",
        note: "Set of three · render",
        alt: "Synthetic Unison illustration: three colorway studies in a row",
      },
    ],
  },
  {
    ...
    images: [
      {
        ...
        alt: "Synthetic Basil Club illustration: sun and rays over a horizon line",
      },
      {
        src: "/images/sc-03-02.png",
        title: "The crop",
        note: "Story format · launch",
        alt: "Synthetic Basil Club illustration: close crop of the launch motif",
      },
      {
        src: "/images/sc-03-03.png",
        title: "The series",
        note: "Set of three · launch",
        alt: "Synthetic Basil Club illustration: three small launch motifs in a row",
      },
    ],
  },
  {
    ...
    images: [
      {
        ...
        alt: "Synthetic Hotel Aria illustration: arched doorway on a quiet facade",
      },
      {
        src: "/images/sc-04-02.png",
        title: "The threshold",
        note: "Close detail",
        alt: "Synthetic Hotel Aria illustration: close study of the arched threshold",
      },
      {
        src: "/images/sc-04-03.png",
        title: "The set",
        note: "Set of three",
        alt: "Synthetic Hotel Aria illustration: three small arrival studies in a row",
      },
    ],
  },
  {
    ...
    images: [
      {
        ...
        alt: "Synthetic Chronicle House illustration: standing book covers in ink tones",
      },
      {
        src: "/images/sc-05-02.png",
        title: "The spine",
        note: "Close detail",
        alt: "Synthetic Chronicle House illustration: close study of a book spine",
      },
      {
        src: "/images/sc-05-03.png",
        title: "The series",
        note: "Set of three",
        alt: "Synthetic Chronicle House illustration: three small cover studies in a row",
      },
    ],
  },
  {
    ...
    images: [
      {
        ...
        title: "The badge",
        note: "Adapted mark",
        alt: "Synthetic Locale Supply illustration: circular badge with ribbon",
      },
      {
        src: "/images/sc-06-02.png",
        title: "The label",
        note: "Close detail",
        alt: "Synthetic Locale Supply illustration: close study of the badge label",
      },
      {
        src: "/images/sc-06-03.png",
        title: "The placements",
        note: "Set of three",
        alt: "Synthetic Locale Supply illustration: three small badge studies in a row",
      },
    ],
  },
  {
    ...
    images: [
      {
        ...
        alt: "Synthetic Quotient Office illustration: ascending chart bars on a baseline",
      },
      {
        src: "/images/sc-07-02.png",
        title: "The detail",
        note: "Close crop",
        alt: "Synthetic Quotient Office illustration: close study of the chart bars",
      },
      {
        src: "/images/sc-07-03.png",
        title: "The set",
        note: "Set of three",
        alt: "Synthetic Quotient Office illustration: three small chart studies in a row",
      },
    ],
  },
];
